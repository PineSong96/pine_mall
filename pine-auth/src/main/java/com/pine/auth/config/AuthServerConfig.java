...
import com.pine.auth.componet.MallTokenEnhancer;
import com.pine.auth.properties.JwtCAProperties;
import com.pine.auth.service.MallUserDetailService;
...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public KeyPair keyPair() {
        return new KeyStoreKeyFactory(
                        ...
                        jwtCAProperties.getKeyPairSecret().toCharArray()).getKeyPair(jwtCAProperties.getKeyPairAlias(),
