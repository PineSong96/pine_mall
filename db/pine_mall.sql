...
CREATE TABLE `ad_advertiser`  (
  ...
  `operate_name` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '运营者姓名',
  `operate_position` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '运营者职位',
  `operate_identity` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '运营者身份',
  `operate_work_email` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '运营者工作邮箱',
  `operate_id_card` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '身份证号',
  `co_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司名称',
  `COHR` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司简称',
  `co_register_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司注册地址',
  `co_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司地址',
  `co_industry` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司行业',
  `co_business_license` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '公司营业执照URL',
  `is_shield` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否屏蔽同行业',
  `co_ad_scope` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发布广告范围',
  `advertiser_type` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '1广告商 2是接单商',
  `store_type` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '1个人 2 商家',
  `creator` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_operator` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '广告商基本信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ad_order_party
-- ----------------------------
DROP TABLE IF EXISTS `ad_order_party`;
CREATE TABLE `ad_order_party`  (
  `id` bigint(20) NOT NULL COMMENT 'id',
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '接单商家基本信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_space`  (
  `id` bigint(20) NOT NULL COMMENT 'id',
  `ad_sapce_warp_latitude` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '经纬度',
  `ad_spac_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位名称',
  `ad_space_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位描述',
  `ad_space_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位类型',
  `ad_space_show_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位首位展示图',
  `ad_space_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位展示图',
  `ad_space_mv` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位视频',
  `ad_space_due_date` timestamp(0) NULL DEFAULT NULL COMMENT '广告位到期时间',
  `ad_space_show_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位是否展示',
  `ad_space_disable` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告位是否禁用',
  `ad_space_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '广告位预计租金',
  `ad_space_member_id` bigint(20) NULL DEFAULT NULL COMMENT '广告位所属会员id',
  `creator` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_operator` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '广告位基本信息' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('api-gateway', 'order-service,product-service,member-service', '$2a$10$1p0Z0vDG463yDjcIPd.f4.K9/oHIL981i03ha4IjHNezOwrEJTZia', 'read,write', 'password', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `oauth_client_details` VALUES ('member-service', NULL, '$2a$10$DNK7wEecdg92bGJGp47C/eby2YHwsjHLKoOKKH.vrXu82biE2KBCK', 'read,write,test', 'password,refresh_token', NULL, NULL, 7200, 9999999, NULL, 'true');
...
INSERT INTO `oauth_client_details` VALUES ('portal_app', 'order-service,product-service,api-gateway,authorize-server', '$2a$10$E.QABsfckMmlX2W81iqRbuLfnIVfJoGD1nWuYZj0k8ZCPuFqFY2Pu', 'read,write', 'password,authorization_code,refresh_token', 'http://192.168.1.128:8855/callBack', NULL, 1800, 3600, NULL, 'true');
...
CREATE TABLE `sys_dict`  (
  ...
  `pid` bigint(11) NULL DEFAULT 0 COMMENT ' 父ID ',
  `dataType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT ' 数据类别,首字母大写 ',
  `dataCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT ' 数据编码 ',
  `dataValue` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT ' 数据名称/值 ',
  `sortNo` int(11) UNSIGNED NULL DEFAULT 1 COMMENT ' 顺序 ',
  `status` tinyint(2) NULL DEFAULT 0 COMMENT '0正常,1删除',
  `isFixed` tinyint(2) NULL DEFAULT 0 COMMENT '0默认为不固定,1固定',
  `dataDesc` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据描述',
  `updateTime` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `SYS_DICT_PK`(`id`) USING BTREE,
  INDEX `idx_dc_dt`(`dataType`, `dataCode`) USING BTREE
...
INSERT INTO `ums_member` VALUES (10, 4, '派大星', '$2a$10$Bq.Oiaejvq9ZstX8YHGI2eA15Ubd1JwhF/xxAuZB8lWDCmCnqxBX2', 'pai·pi', '15252152525', 1, '2020-08-21 09:23:55', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
